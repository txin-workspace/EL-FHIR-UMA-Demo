...
def share_res(rs_host, rs_port, el_dev_id, access_token, target_user):
    url = 'http://{}:{}/elapi/v1/devices/share/{}/properties'.format(
        rs_host, rs_port, el_dev_id)
...
def unshare_res(rs_host, rs_port, el_dev_id, access_token, policy_id):
    url = 'http://{}:{}/elapi/v1/devices/share/{}/properties'.format(
        rs_host, rs_port, el_dev_id)
